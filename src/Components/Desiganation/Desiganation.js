...
const Desiganation = () => {
  ...
  const fetchDesignations = useCallback(async () => {
    ...
    setError(null);
    try {
      const response = await fetch(`${process.env.REACT_APP_BASE_URL}/api/designations/`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editIndex !== null) {
        ...
        response = await fetch(`${process.env.REACT_APP_BASE_URL}/api/designations/${designationToEdit.id}/`, {
          method: 'PUT',
        ...
        response = await fetch(`${process.env.REACT_APP_BASE_URL}/api/designations/`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(formData)
        });
  ...
  const confirmDelete = async () => {
    ...
    setError(null);
    try {
      const response = await fetch(`${process.env.REACT_APP_BASE_URL}/api/designations/${designationToDelete.id}/`, {
        method: 'DELETE'
      });
      if (!response.ok) throw new Error('Network response was not ok');
